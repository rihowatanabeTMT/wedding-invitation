...
public class MessageService {
    ...
    private String createAttendMessage(RsvpForm form) {
        return switch (form.getRelation()) {
            ...
            case "senior" ->
                "当日お会いできることを楽しみにしております<br>"
              + "10:30までに3階にて受付をお済ませいただきますようお願いいたします<br>"
              + "エレベータなど混み合う可能性がございますため、<span class=\"br-sp\"></span>早めにお越しください";

            case "friend" ->
                "当日、会えるの楽しみにしてます！<br>"
              + "受付は10:30までに3階にてお済ませください<br>"
              + "混むかもだから早めに来てね！";

            default ->
                "当日お会いできることを楽しみにしております<br>"
              + "受付は10:30までに3階にてお済ませください";
        };
    }
    ...
    public String createSpecialMessage(RsvpForm form) {
        ...
        return switch (form.getRole()) {
            case "reception" ->
            	"当日お会いできることを楽しみにしております！<br>"
            	+ "また、受付のご協力をいただき、ありがとうございます<br>"
            	+ "9:30までに３階受付会場へお越しください<br>"
            	+ "詳細は追ってご連絡しますので、よろしくお願いいたします";

            case "toast" ->
            	"当日お会いできることを楽しみにしております！<br>"
            	+ "9:30までに3階受付会場へお越しください<br>"
            	+ "乾杯のご挨拶およびリングボーイ＆ガールを<span class=\"br-sp\"></span>お引き受けいただき、心より感謝申し上げます";
